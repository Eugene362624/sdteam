...
function App() {
  ...
  window.onscroll = (e) => {
    ...
    document.querySelector('.about-left > img').style.cssText = `transform: translate3d(${Math.floor(.3*window.pageYOffset) - 150 > 120 ? 120 : Math.floor(.3*window.pageYOffset) - 150}px, -${Math.floor(.05*window.pageYOffset) > 45 ? 45 : Math.floor(.05*window.pageYOffset)}px, 0)`
    if (document.querySelector('.num-1').offsetTop <= (window.scrollY+window.innerHeight/2) && !document.querySelector('.num-1').classList.contains('shown')) 
    {
    ...
    if (document.querySelector('.num-2').offsetTop <= (window.scrollY+window.innerHeight/2) && !document.querySelector('.num-2').classList.contains('shown')) 
    {
    ...
    if (document.querySelector('.num-3').offsetTop <= (window.scrollY+window.innerHeight/2) && !document.querySelector('.num-3').classList.contains('shown')) 
    {
